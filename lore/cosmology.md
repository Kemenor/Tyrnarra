...
- **Regional traditions** vary in character:
  ...
  - **Brauogi mineral-Magitech (Arcanotech, with the continent's only routine Primotech work)**: Sarrum-domain, stone-and-ore work; the legendary Primotech items are mostly Brauogi-grown, specifically in **Hirubaso**, the sacred druid grove at the heart of the Earth Realm (see `geography/brauogi.md`, *The Earth Realm*).
