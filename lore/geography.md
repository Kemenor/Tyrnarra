...
- **Azkamour**: border territory straddling Vindul and Brauogi, capital on the Brauogi side. *(Basque azkar "swift" + muga "border": "the Swift March.")* A wind-touched fertile-grain borderland where Brauogi's northern grain meets Vindul's storm-fishing routes; the fast riders carry both ways. See also Brauogi.
...
**Terrain:** Rolling fertile lowlands cut by dense river networks; the rivers spring from plentiful mountain ranges that frame and feed the interior. Southern dense forest. Western dark-mountains shelter the domain from weather rolling in off the Hafra coast. Agricultural heartland in earth-tones throughout: deep greens, brown river-soil, grey-and-rust mountain-stone, the gold of late-summer fields.
...
**Sub-regions:**
- **Gotorlekua**: houses Lurrath, Sarrum's city-state. *(Basque gotor "strong, firm" + leku "place" + -a "the": "the Stronghold.")* The defensible interior heart of the domain; the city-state and the sub-region grew together.
- **The Earth Realm**: a sub-region fitting the domain's Earth character. Character canon-pending.
- **Azkamour**: border territory straddling Brauogi and Vindul, capital on the Brauogi side. *(Basque azkar "swift" + muga "border": "the Swift March.")* A wind-touched fertile-grain borderland where Brauogi's northern grain meets Vindul's storm-fishing routes; the fast riders carry both ways. See also Vindul.
- **Twin Suns**: coastal sub-region on the Midarra-touching corner; Soul Tree island lies just offshore. The name records a phenomenon native to the sub-region; origin TBD (see `docs/open-threads.md`). Modern English name.
