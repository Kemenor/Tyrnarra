...
**Etymology:** Basque *lautada* (plain, flatland) → *lauta* → drifted to *Lautara*

**Position:** Northwest-central Talan, directly south of Vindul

**Terrain:** Sandy steppe and desert (dominant), grass steppe in the north (transition from Vindul), dramatic dark mountains along the western edge (Cloud Sea side), forested green highlands to the east, river system, coastal access to the southeast. Eastern cultural character.

**God's city:** Merkavar, The Market City
...
- **(Unnamed Northwest Port)** *(canon-pending name)*: a semi-shady coastal port-town on Lautara's northwest seaboard at the tri-domain border where **Lautara** (Commerce), **Floteyn** (Water), and **Myrkono** (Darkness) meet. **Floteyn's eastern boundary is redrawn slightly to touch Lautara's western coast** so this tri-point exists; the redraw is the canon prerequisite for the town. Foggy harbour, three different docking traditions arguing about which one assesses fees, salt-rotten warehouses, and an interior where you can lose someone in two blocks. The Myrria second-chance doctrine inflects the town's character: many residents have decided to be someone new and the town accommodates them. **Functionally independent** of all three neighbouring domains in the same pattern Crossroads uses for its southern tri-point. The town's wider character (name, etymology, ruling structure if any, who handles its harbour-masters' detente, named institutions) is canon-pending and will be developed in a future drafting pass; the placeholder exists to lock in the geography and the prerequisite Floteyn boundary redraw.
...
**Position:** South-central Talan, north of Lioaru, south of Midarra, bordered by Sumendar to the west and Ezkudon/Egulon to the east

**Terrain:** Wide, green, fertile, Talan's breadbasket. Rolling hills and river valleys dominant. Multiple mountain ranges present but not harsh. Dense forest in the south. River network throughout. Agricultural heartland with old noble houses controlling river trade.

**God's city:** Lurrath, The Steadfast City
