...
**Terrain:** Rolling cultivated land cut by a dense river network; the rivers all converge on the great interior lake at Merkavar. Mountains rim the western edge facing the Order of Steam bay. Eastern-cultivated highlands at the western margin (housing Emarrea). Southern dense forest at the Wildreach border. Northern Midarra coast for sea-trade; the long inland caravan-and-train network for everything else. Desert is not a Lautara register: the desert-nomad cultural ground belongs to neighbouring Lioaru, and Lautara distinguishes itself by being the watered land where caravans rest.

**Cultural character:** Eastern, domain-wide. Silk-road merchant culture: caravan staging-yards, lake-port assembly, river-junction warehousing, train-yard depots. Merkavar reads in the Samarkand / Bukhara register (great inland lake-city, market by name and by function). Sub-regions vary the intensity (Emarrea full kotokoe-and-kitsune; Merkavar and Azkataria silk-road merchant-Eastern; Rika Tikur drifted-Icelandic-but-mercantile; Dreaming Cape modern-Eastern mercantile-port; Crossroads tri-state-neutral) but the Eastern register holds across the domain. Most of Talan's overland trade passes through Lautara at some point in its journey.
...
**God's city:** Merkavar, The Market City. Sits on a great inland lake in Azkataria's interior. Rivers feed the lake from all sides and one major river flows out toward the Midarra coast. The lake-city is a destination, not a port: ships reach the Midarra coast at Rika Tikur or the Dreaming Cape, goods transfer to river-craft or caravan-train, and arrive at Merkavar to be sorted, valued, and redistributed onward.

**Sub-regions:**
- **Azkataria**: the lake-interior sub-region that houses Merkavar. The lake and its river-system are Azkataria's defining feature; the sub-region's economy is the lake-city's economy at one remove.
- **Emarrea**: the kitsune kingdom on Lautara's western margin (the eastern-cultivated highlands neighbouring **Hareaveldi** (Lioaru), **Tahu Tangata** (Sumendar), and **Wildreach** (Lautara/Ezkudon border)). Corner-touch with **Galdua Jendea** (Lioaru) means the Denbora sand-whale-city periodically drifts close enough for envoys to cross. Downstream river-trade channel into the **River Duchies** (Lioaru) provides a secondary distribution backbone for sake, orchard goods, and theatrical-illusion exports, separate from the main Lautaran merchant-house network. Capital: **Biozuri**. Notable village: **Kawaakari**. Internal landmark: the **House of a Thousand Flavors** in Heartplaza, the capital's central district. The kitsune culture is detailed in `cultures.md`.
...
- **The Dreaming Cape**: coastal sub-region of Lautara sitting in front of the Order of Steam bay alongside Rika Tikur. A dreamy mercantile reach where forge-smoke drifts in from the OoS interior, sunsets read as omens, and dock-side inns specialise in dream-blends. Modern English name. (Character canon-pending; this is the seed.)
- **Wildreach**: borderland shared with Ezkudon. The wild-touched live here. Modern English name.

**Note on Crossroads**: the trade-nexus settlement at the Zuzental/Lautara/Egulon southern tri-point sits at the edge of Lautara's eastern reach but is canonically detailed under Zuzental (see *Zuzental → Sub-regions*). The swap restores Crossroads to its original Lautara-tri-state design.
...
**Sub-regions:**
- **The Wildreach**: shared with Lautara. Unclaimed borderland between the two domains. The wild-touched live here. See also Lautara.
