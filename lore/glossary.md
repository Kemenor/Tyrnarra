...
- **The Stormpact**: Modern English-stratum coinage. *Storm* + *pact*; the chartered constitutional agreement that joins the kingdom's two halves (the Skybell Republic on the coast and the Thunderhost in the interior). Sworn in the early Adventurer Era when post-Dark-Era trade re-opened the Vindul passes and the two halves of the region had to agree on a shared law or be ruined by competing for the same traffic. Distinct from the *Compact of the Bound Thirteen* (the Gods' Law); the local language uses *Stormpact* and *Compact* without confusion. Full canon in `geography.md`, *Vindul → Fellibylur*.
...
Full geography in `geography.md` and god-deep-dive in `secret-history.md`, *Araphel: Lore Notes*.
