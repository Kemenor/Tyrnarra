...
- **The Dreaming Cape**: Modern English (modern stratum). Substantial coastal sub-region of Lautara forming the north-east headland of the Order of Steam bay and wrapping around the bay's south and east coasts. Carries a phenomenon locals call **the drift**, a persistent dreaming sub-state of the local air read as Bikiargi's nearness by temple doctrine and as multiple folk-theories by everyone else (cause genuinely canon-pending at chronicler-tier; the GM-tier truth is a subsurface Stillpool-river, see `secret-history.md`, *The Dreaming Cape: The Real History*). Governed by the **Cape Theocracy of Bikiargi** (see *Faction proper nouns → The Twin Lantern*), a gynocratic theocracy headed by the paired identical-twin **Bright Voice** and **Dark Voice**. The dream-trade and the **Wakehelm** pilot-craft are the polity's signature exports. Capital: **Moonwatch**.
...
- **Elden tech**: Plain English. The actual technological source for modern Arcanotech. **The Elden were a high-tech civilisation** (6000–2945 GR) before fusing with the Devourer to become the Corrupted God; their ruins yielded the rail, atmospheric, and industrial foundations modern Magitech evolved from. **Ultra-High-Tech Civilisation (UHTC)** is the folk-term mortals sometimes use without knowing the source was the Elden; scholarly usage just says *Elden tech* or *Elden-origin*. **No longer an open thread.** Full canon in `secret-history.md`, *The Elden*, and `cosmology.md`, *Technology: Magitech and Infrastructure*.
...
Full geography in `geography/myrkono.md` and god-deep-dive in `secret-history.md`, *Araphel: Lore Notes*.
