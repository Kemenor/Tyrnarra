...
- **Golivander.** Pre-rule existing name (the GM's prior worldbuilding, predates the naming convention). The most-travelled chronicler of Talan; a known name in the literate classes of every continent kingdom that prints books. Full name **Golivander Tessek**, but he signs everything *Golivander* in print and *G.* in column sign-offs; the Tessek clan-name appears only at formal introduction.
  - **Race and birth.** **Tengu**, born on **Haizetsua** (the great western tengu island of Vindul). Left Haizetsua young; the island appears in his work only as the place he came from, never as a subject he writes about with insider authority. His Tengu lifespan (150–200) is what makes the multi-decade chronicler career structurally possible.
...
- ***A Traveller's Guide to Tyrnarra***. Golivander's formal multi-volume reference work. The official product — formal-philosophical voice, treated by literate-class Talanese as the standing reference on everything from continental geography to the Gods' Law. The volume on **The Gods' Law** is the most-quoted (the epigraph on [gods-law.html](../gods-law.html) is drawn from it; chronicler glosses cite him by volume). Reprinted often; available openly in the markets of Frae City and Lograth. Pre-rule existing title.
