...
- **Itsasalda**: Basque *itsasoaldea* "the seaside region" (*itsaso* "sea" + *aldea* "region") → vowel-loss to **Itsasalda** "seaside." The central-northern coastal sub-region of Lautara, sitting between the Dreaming Cape (west, which encloses the Order of Steam bay) and Atarialda (east). Open coastal-and-plains country with a Midarra-facing port-trade arm: ships in to its coastal towns, goods south by river and overland to Merkavar. The river that forms Itsasalda's southern border with Emarrea (eastward to Merkavar's lake) is the main inland-water route; the river's name is canon-pending. The Cape's bay handles the OoS industrial freight; Itsasalda's coast handles the general Midarra coastal trade.
