...
- **Magitrain** — Plain English (modern, lightly drifted from *magic train*). The everyday name for the Arcanotech rail vehicles that run the continental network. **The technology descends from recovered Elden tech**, reverse-engineered, refined, and now mass-produced. Two interconnected networks (Northern Talan, Southern Talan) cover most of the continent; the **Great Jungle (Basogur)** prevents through-rail between them.
- **Grav Train** — Plain English (legacy term). What the original Elden-tech recovered prototypes were called before Magitech engineering scaled the technology. *Pedants distinguish Grav Train (Elden-recovered original) from Magitrain (modern mass-produced); most people use the terms interchangeably.*
