...
- **Millhaven** — town on the Millwater River, Dreaming Cape / Earth Realm border (modern English — fits the rule for new things)
- **Millwater River** — runs south to Midarra (English, fits)
- **Midarra** — major city downriver from Millhaven (likely older — etymology TBD)
- **Rika Tikur** — independent coastal city west of Millhaven (etymology TBD)
- **The Dreaming Cape** — region (English-style — possibly modern naming)
- **The Earth Realm** — region (English-style)
...
## New names coined this session

*(none yet — add entries here as we create them)*
