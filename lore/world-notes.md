# World Notes — Tyrnarra Lore Reference

A running file for complex, easy-to-misremember lore facts. Read this before writing anything about cosmology, the gods, or history.
...
- There are **only 13 Grand Gods** — the original twelve creators and Cronus (see below).
...
- It is **not a rule — it is physics.** A god who enters the Material Plane is subject to it automatically, the same way gravity applies. It cannot be broken by willpower or loophole.
...
**Modern Magitech is recovered Elden technology, evolved.** The Elden civilisation (6000 GR – 2945 GR — see *The Elden* below) was a high-tech people in its own time; before its fusion with the Devourer to become the Corrupted God, it built rail-bound mass acceleration, atmospheric vessels, and a great deal else. Most of that work was lost when the civilisation transformed; the ruins were not.

**Modern Magitech evolved from Elden-ruin discoveries** — primarily in the post-Crimson-Rain centuries, as surviving Talanese kingdoms began the systematic archaeology that the Storveldi Denbora had begun before the Week of Crimson Rain (the Storveldi Denbora focused on the *divine-engineering* side of Elden tech — the integration procedure; modern Magitech focused on the *industrial* side). **The Order of Steam** in Sumendar grew up around an Elden-tech excavation in volcanic terrain; their early breakthroughs reverse-engineered Elden rail principles into the first true Magitrain prototypes, refined past the originals' limitations, and from there scaled. Every modern Arcanotech engineering tradition traces back, at one or two removes, to Elden archaeology.

**The colloquial folk-term "Ultra-High-Tech Civilisation" (UHTC)** is what less-educated mortals call the source — most don't know the source was specifically the Elden. Scholarly usage just says *Elden-tech* or *Elden-origin*. Most surviving Elden ruins are concentrated in Sumendar, Brauogi, and the Lioaru / Lost Kingdom border (where the Storveldi Denbora's ruins sit atop the Elden ruins they built on top of).
...
- **Regional traditions** vary in character:
  ...
  - **Brauogi mineral-Magitech (Arcanotech, with the continent's only routine Primotech work)** — Sarrum-domain, stone-and-ore work; the legendary Primotech items are mostly Brauogi-grown.
...
| **Water** | **Ships** | Normal wooden, or Magitech (typically Arcanotech; Occultech for chaos-water specialists) | Ships are everyday; normal wood-and-sail dominates by count, Magitech ships are the wealth upgrade. |
| **Sky** | **Airships** | **Always Magitech.** Arcanotech or Occultech. | Uncommon but present. **There are no non-magical airships** — flight requires Magitech. Arcanotech airships use rune-arrays for lift; Occultech airships **bind an air elemental** as their lift-and-direction principle. |
...
- **"Grav Train" is the legacy term** for the original Elden-tech recovered prototypes — what the first reverse-engineering era called them. "Magitrain" is the modern industrial-production word. Pedants distinguish; most people use the terms interchangeably.
- **The network is two halves.**
  - **Northern Talan network** — interconnects the northern domains and their major cities. Confederated multi-operator system; the Order of Steam's licensed lines dominate, local lines exist.
  - **Southern Talan network** — same for the south. Sumendar (where the Order of Steam manufactures most of the rolling stock) is the southern network's industrial heart.
  - **The two are not directly connected.** No through-rail crosses **Basogur Jungle** — the deep jungle sub-region straddling Nashavel and Ehizahar that bisects the continent's east-central waist. Multiple Magitech engineering projects over the decades have attempted the crossing; all have failed. The reasons are three, and they compound:
    ...
    2. **Indigenous resistance.** Vanara, leshy, beast-spirits, and resident druids of the jungle actively dismantle any rail-laying attempt as it happens. Attempts to escort projects with armed crews escalate into running conflicts the engineers cannot win without becoming an occupation.
  ...
  - **North-south travel** is therefore done by other means: by **ship across Midarra** (the inner freshwater sea, bulk cargo's preferred route), by **airship over Basogur** (the premium passenger / urgent-freight option — Arcanotech airships do this regularly but suffer turbulence and instrument drift in the chaos-magic uplift; **Occultech airships fly through it cleanly** and charge accordingly), or by the **long overland road that loops around Basogur** — slow, monetised by toll-collecting kingdoms along the bypass. The Pirate Lords of the Twin Cities (Midarra) draw real revenue from being a routine north-south transit point; the Vindul-and-Sumendar airship guilds draw real revenue from the over-jungle route.
...
- **Living lineage on Talan: Dragonets** (see `bestiary.md`). Small dragonlike sapients native to Talan, his direct ancestral children, distinct from the alien Dragons. Dragonet populations concentrate in the upper Darklands and the Basogur Jungle — the same places Zaharsuge's domain bleeds through.
