...
**Peoples:** Three dominant ancestries are anchored here: **Fetchling** (Ilun Tasun), **Centaur** (the **Eizhalun** of the Shadow Steppes), and **Surki** (Itzasoa). The domain-level read is a feeling of each people, never a practice; the cultures live with the sub-regions, and the three feelings are three answers to the same dark, which in Araphel's domain is the quiet and never the enemy.
...
- **The Centaurs ride the night open.** For a Centaur, dusk is the walls coming down: the steppe after dark is the widest country on Talan, and it is theirs. Range as temperament, life measured in ground covered under stars, and the ride is never alone: home, to a Centaur, is a direction and the clan riding it with you, never an address. They trust the way other peoples own, ground they cannot see at full gallop, the rider at their flank, the night itself, and a Centaur who has decided you may ride with the clan has given you what a house-dweller gives with a key.
...
The dark keeps your past if you wish it kept, opens the steppe to the riders, and asks nothing of the body that wears chitin. **Myrria**, the City of Second Chances, belongs to no one people: the divine city takes all comers, which is the point of it.
...
- **Shadow Steppes**: the open steppe territory of the domain, shadow-touched plains. The "nomadic clans" and "wandering clans" of the Wardstone record are the **Eizhalun** (the centaur people; see *The Eizhalun and the Surki* below). Holds **two Wardstones**: the **Lakeside Wardstone** (set within a city on the shores of the great lake; the city grew around it as Eizhalun clans gathered to guard its light; anchors both commerce and faith) and the **Steppes Wardstone** (alone in the open grasslands, protected by the wandering Eizhalun; both pilgrimage site and wartime rallying point). Also contains **the Hollow of Ten Thousand Threads**, the Vermin Queen's hive-dungeon and the leakage point for spider-swarm corruption seeding lesser nests across the plains (see *Notable Locations* below).
...
#### The Eizhalun and the Surki: the Steppe Watch
...
**The Eizhalun** (the centaur people; *night-hunt*, see [`../glossary.md`](../glossary.md)) are the Shadow Steppes' own: the night-riders whose clans have ranged the open grass for as long as the steppe record reaches. They are the nomadic clans the Wardstone record credits with guarding the open-steppe stones: they ride the night between the Lakeside and Steppes Wardstones, running down swarm-spawn before a nest can root, and the steppe watch is the clans' shared work and oldest pride. They ride under Araphel, for whom darkness is the cover and the quiet, not the enemy. Full ancestry placement in [`../ancestries.md`](../ancestries.md), *Centaur*.
...
On the Shadow Steppes the two peoples are the two halves of one watch: the Eizhalun ride the grass above, the Surki climb the deep below, and they hunt the same enemy from opposite sides of the ground. They keep no shared culture and little shared language; what they share is the Hollow, and the certainty that the chains of the bound must hold.
