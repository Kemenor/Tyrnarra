...
Beyond the Fetchling who built Myrria, Myrkono is home to two peoples the rest of Talan does not associate with the Darkness domain, because both arrived rather than began here. They share an enemy and divide a single watch between the grass and the deep.

**The Eizhalun** (the centaur people; *night-hunt*, see [`../glossary.md`](../glossary.md)) were a Hunt-domain people once: the longest-ranging of the Lands of Villtur tribes (Ehizahar), whose hunt-circuits ran wider than Orc, Kholo, or Lizardfolk would follow. During the Dark Era, swarm-spawn began crawling west out of the Hollow of Ten Thousand Threads and spilling across the open grass. The centaurs followed the corruption-beasts out of Ehizahar to run them down, and the hunt never ended; clan by clan they stopped returning, until by the post-Dark-Era reconstruction the centaurs of Villtur were a memory and the centaur people kept the Shadow Steppes. They are the nomadic clans the Wardstone record credits with guarding the open-steppe stones: they ride the night between the Lakeside and Steppes Wardstones, running down swarm-spawn before a nest can root. Hunt-craft survived the crossing; the Hunt-god did not follow whole. They hunt by starlight under Araphel, for whom darkness is the cover and the quiet, not the enemy; Hinka endures among them as old-memory and method, not worship. Full ancestry placement in [`../ancestries.md`](../ancestries.md), *Centaur*.

**The Surki** (insectoid sapients of the deep places) climbed up out of the upper Darklands, and Myrkono is the one domain that takes them in: Araphel's darkness asks nothing of the compound-eyed and chitinous, and Myrria's second-chances doctrine extends them the welcome that cities elsewhere refuse. They live throughout the domain's deep and shadowed places, the mountain underways, the under-vaults below Myrria, the old-forest hollows, and most militantly the Shadow Steppes, where the Vermin Queen's Hollow seeds corruption outward and the Surki organise to resist precisely the fate it represents. Surki are insectoid but **not corrupted**; their war with the Vermin Queen's swarm is the thing they exist to wage. Full ancestry placement in [`../ancestries.md`](../ancestries.md), *Surki*.
