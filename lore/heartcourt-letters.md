...
See also: `glossary.md` (*Golivander*, *The Travelling Chronicle*, *Letters from Biozuri*); `geography/lautara/emarrea.md` (*The Heartcourt → Per-Heart vignettes*) for the canonical events these columns reference.

---

## Column 0 · Editor's Preface to Letters from Biozuri
...
## Column 1 · On the Heart Who Says Less and Knows More
*(Saemi, Azure)*
...
## Column 2 · On the Heart Whose Generosity Is Also a Wager
*(Houreni, Golden)*
...
## Column 3 · On the Heart Who Loves the Orchards
*(Shionori, Emerald)*
...
## Column 4 · On the Heart Who Is Still Astonished to Find Himself Here
*(Norikaze, Ivory)*
...
## Column 5 · On the Heart Who Is Currently Two Hearts
...
## Column 6 · On the Heart Who Was Always Going to Be Written About
*(Reien, Rose)*
...
## Column 7 · On the Heart Who Holds Every Other Heart's Names
...
## Column 8 · On the Spectacle the Kingdom Is Watching Instead of Working
*(The Onyx Spectacle)*
...
## Column 9 · On a Single Public Second
*(The Kiss · the long dispatch)*
...
## Column 10 · On an Afternoon at Kawaakari with the Retired Crimson Heart
*(Yorimichi's Catjomin tasting · Kawaakari supplement · food-blogger register)*
...
## Open in the chronicle record (canon notes)

A handful of details inside the columns are deliberately under-specified in canon. Flagged here so future writes can either ratify or vary them:
...
- **The Heart who walks the gardens at sunrise with Saemi (Column 1).** Norikaze. The column's coyness is Golivander's voice; canon has the bond fully named in `geography/lautara/emarrea.md` and on the Heartcourt page.
