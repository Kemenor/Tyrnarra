...
| **The Flesh-Sculptor** | Butcher who remakes flesh to the Corrupted God's design | Lair of stitched horrors and alchemical vats. **Earmarked to Nashavel** (Chaos · Vesuna): change corrupted, Vesuna's own aspect turned inside out; precise site lands at the Nashavel build. |
...
The Vermin Queen's lair (the Hollow of Ten Thousand Threads, Itzasoa) is documented in [`geography/myrkono.md`](geography/myrkono.md), the Maw Serpent's is sited beneath the north pack-ice of Baerfrost ([`geography/vindul.md`](geography/vindul.md), *Baerfrost*), the Root-Twister's beneath the breadbasket-basin of Greenward ([`geography/brauogi/greenward.md`](geography/brauogi/greenward.md), *The grey at the margin*), and the Whisperer in Dreams' drowned temple beneath the Floating Isles of Shuun ([`geography/floteyn/floating-isles.md`](geography/floteyn/floating-isles.md)).

**All nine dungeons now carry a domain (earmark pass, 2026-08-11): one General per domain, nine domains of thirteen.** The five above without full canon (Ash-Binder's dead lair in Sumendar; Rot-Tyrant in Lioaru; Blight-Seer in Ezkudon; Flesh-Sculptor in Nashavel; False Saint in Egulon) are earmarked at domain level only, with precise siting and eruption-and-containment history landing at each domain's build (the Baerfrost / Greenward / Floating Isles pattern). **Four domains carry no dungeon of the Nine: Ehizahar, Askamira, Lautara, and Zuzental.**
