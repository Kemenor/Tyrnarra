...
The Vermin Queen's lair (the Hollow of Ten Thousand Threads, Itzasoa) is documented in [`geography/myrkono.md`](geography/myrkono.md), the Maw Serpent's is sited beneath the north pack-ice of Baerfrost ([`geography/vindul.md`](geography/vindul.md), *Baerfrost*), and the Root-Twister's beneath the breadbasket-basin of Greenward ([`geography/brauogi/greenward.md`](geography/brauogi/greenward.md), *The grey at the margin*); the other five dungeons' precise locations remain TBD.
