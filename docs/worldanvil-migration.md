...
- ~~**Dragonkin** descend from an unholy creation of one of the gods later expelled by the Gods' Law. No relation to Dragons.~~ → **Removed from canon 2026-05-17.** Dragonkin was a D&D 5e migration relic with no narrative footprint worth keeping; ancestry deleted from `bestiary.md` and all HTML references stripped.
