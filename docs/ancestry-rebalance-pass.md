...
- Queue after: Merkavar gap-check, Haizava gap-check, Frae City verify, Lograth stub peoples line, then the four seed notes (Uravel/Veidrath/Lurrath/Ljosarn) with rosters + city-angle sketches, printed verbatim at surface.
