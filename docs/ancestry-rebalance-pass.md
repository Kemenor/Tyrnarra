...
- **Valreka 🔵 next.** Nagaji = the missing third tense at full weight (rebirth-rites cadence + presiding at beginnings + CLOSING THE DIGS, the leaving-rite, shed-skin custom; the third voice in the halt-vs-move argument). **USER CAUGHT a no-migration violation in draft 1** ("come down from Hareaveldi"): the Valrekan Nagaji are founding presence (aboard since the faithful took to the whales), never migrants. Corrected draft pending approval.
