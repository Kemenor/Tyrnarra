...
Run from the repo root, e.g.:
  ...
  python campaigns/map-library/stitch.py \
    --consist "01 Engine,28 Cargo Coal,24 Military Transport,14 Steerage,23 Cannons,03 Crew Quarters" \
    --terrain Rock --out narrows-job-train --maps campaigns/furrious-five/assets/maps
...
def main():
    ...
    ap.add_argument("--maps", required=True,
                    help="campaign maps dir, e.g. campaigns/furrious-five/assets/maps")
