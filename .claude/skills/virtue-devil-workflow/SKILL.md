...
- **The Council question.** What is this devil at the table of Fourteen: the slow voice, the procedural blade, the swing seat, the one who has spoken twice in a century? And where do they stand on the standing truce between the banks (the publicly-known peace)? The uncalled Ofunda debt is off-limits to every seat but Jafnar (see *Existing hooks*).
...
7. **Seat at the Council of Fourteen.** Devil-specific, with no demon equivalent: their voice in consensus debate, their alliances and oppositions among the fourteen, their stance on the détente. The uncalled Ofunda debt stays off-limits to every seat but Jafnar (see *Existing hooks*).
...
Bolverk canon is GM-leaning by nature, but the discipline still applies: the entry's open sections are what Bolverk itself could know; the `⚿ GM Secret:` heading marks what even Bolverk does not. Prose rules per *Hard rules*. Concrete sensory detail over abstraction (the smell of the ziggurat's third tier, the sound the Council door makes, the gesture the devil's petitioners learn).
...
6. **The Council.** How does this devil vote, and where does it stand on the standing truce between the banks? (The Ofunda debt stays off-limits per *Existing hooks*; only when grilling the Justice Devil himself, ask why he has not called it.)
...
- **Breaking the Justice restraint, or leaking the secret.** Any devil other than Jafnar who knows the uncalled Ofunda debt exists, references it, or acts on it breaks hard canon (see *Existing hooks*); a non-Jafnar devil's Council stance is about the standing truce, never the debt.
