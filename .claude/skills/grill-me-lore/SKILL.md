...
7. **Ancestry — only if relevant.** If an ancestry anchors here, what about **THIS place** changes how this ancestry lives? Don't accept the one-line lore as the answer. Push for what being from *here* adds on top of being of *this people*. The Itsasalda-vs-Azkataria Vishkanya contrast (the patient Reckoners who count tides for the Vordsbench vs. the coffee-table philosophers who argue policy into being) is the model: same ancestry, opposite lives.
