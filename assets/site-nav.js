...
(function () {
  ...
  var NAV_HTML = [
    ...
    '',
    '  <div class="nav-section">',
    '    <div class="nav-section-label">Sub-Regions &amp; Cities</div>',
    '    <ul class="nav-list">',
    '      <li><a href="/talan/domains/ehizahar/fenurra.html"      data-page="fenurra">Fenurra · The Flame-Source</a></li>',
    '      <li><a href="/talan/domains/lautara/emarrea.html"       data-page="emarrea">Emarrea · The Kitsune Kingdom</a></li>',
    '      <li><a href="/talan/domains/myrkono/myrria/myrria.html" data-page="myrria">Myrria · City of Second Chances</a></li>',
    '    </ul>',
    '  </div>',
    '',
    '  <div class="nav-section">',
